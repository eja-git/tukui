...
local leftpanelWidth = 470
local rightpanelWidth = 470
...
function Panels:Enable()
	...
	BottomLine:Size(2)
	BottomLine:Point("BOTTOMLEFT", 0, 20)
	BottomLine:Point("BOTTOMRIGHT", 0, 30)
	...
	DataTextLeft:Size(leftpanelWidth, 23)
	...
	DataTextRight:Size(rightpanelWidth, 23)
	...
	if C.Chat.Background then
		...
		LeftChatBG:Size(leftpanelWidth + 12, 200)
		...
		RightChatBG:Size(rightpanelWidth + 12, 200)
		...
		TabsBGLeft:Size(leftpanelWidth, 23)
		...
		TabsBGRight:Size(rightpanelWidth, 23)
