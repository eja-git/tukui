...
function TukuiUnitFrames:Player()
	...
	Power.Prediction:SetWidth(C.UnitFrames.Portrait and 214 or frameWidth)
	...
	AdditionalPower:Size(C.UnitFrames.Portrait and 214 or frameWidth, 8)
	...
	AdditionalPower.Prediction:SetWidth(C.UnitFrames.Portrait and 214 or frameWidth)
